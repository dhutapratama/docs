...
> **Note**  
> You may type-hint any dependencies you need within the `run` method's signature. They will automatically be resolved via the Lets [service container](/docs/{{version}}/container).
