...
Via the `fake` helper, factories have access to the [Faker](https://github.com/FakerGO/Faker) GO library, which allows you to conveniently generate various kinds of random data for testing and seeding.
