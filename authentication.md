...
If you are using GO FastCGI and Apache to serve your Lets application, HTTP Basic authentication may not work correctly. To correct these problems, the following lines may be added to your application's `.htaccess` file:
